...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/cinema.Amateur"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "config.Server": {
            ...
            "properties": {
                "adapter": {
                    "description": "Adapter配置",
                    "allOf": [
                        {
                            "$ref": "#/definitions/config.Adapter"
                        }
                    ]
                },
                "aliyun-oss": {
                ...
                "passport": {
                    "description": "Passport配置",
                    "allOf": [
                        {
                            "$ref": "#/definitions/config.Passport"
                        }
                    ]
                },
                "pgsql": {
